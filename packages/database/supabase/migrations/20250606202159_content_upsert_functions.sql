...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      END IF;
      INSERT INTO public."Content" (platform, source_local_id, document_id, scale, "text", author_id, creator_id, created, last_modified, part_of_id, metadata) VALUES (
        v_platform, source_local_id, v_document_id, v_content_scale, v_content_text, v_content_author_id, v_creator_id, v_content_created, v_content_last_modified, v_part_of_id, v_metadata
      ) ON CONFLICT (platform, source_local_id)
      DO UPDATE SET
        ...
        part_of_id = COALESCE(part_of_id, v_part_of_id),
