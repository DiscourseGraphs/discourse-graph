...
drop function if exists "public"."match_content_embeddings"(query_embedding vector, match_threshold double precision, match_count integer, current_document_id integer);
