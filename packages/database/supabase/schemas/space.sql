...
COMMENT ON TABLE public."DiscoursePlatform" IS
...
COMMENT ON TABLE public."DiscourseSpace" IS
'A space on a discourse platform representing a community engaged in a conversation';
...
ALTER TABLE ONLY public."DiscourseSpace"
ADD CONSTRAINT "DiscourseSpace_discourse_platform_id_fkey" FOREIGN KEY (
