...
ALTER FUNCTION "public"."match_content_embeddings"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer, "current_document_id" integer) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."match_embeddings_for_subset_nodes"("p_query_embedding" "extensions"."vector", "p_subset_roam_uids" "text"[]) RETURNS TABLE("content_id" bigint, "roam_uid" "text", "text_content" "text", "similarity" double precision)
    LANGUAGE "sql" STABLE
    AS $$
