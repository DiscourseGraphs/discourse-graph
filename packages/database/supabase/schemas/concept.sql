...
ALTER TABLE ONLY "public"."Concept"
    ADD FOREIGN KEY (represented_by_id) REFERENCES "public"."Content" (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE ONLY "public"."Person"
    ADD CONSTRAINT "Person_pkey" PRIMARY KEY ("id");

CREATE INDEX "Concept_content" ON "public"."Concept" USING "gin" ("content" "jsonb_path_ops");
...
ALTER TABLE ONLY "public"."Concept"
    ADD CONSTRAINT "Concept_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."Agent"("id") ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE ONLY "public"."Concept"
    ADD CONSTRAINT "Concept_schema_id_fkey" FOREIGN KEY ("schema_id") REFERENCES "public"."Concept"("id") ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE ONLY "public"."Concept"
    ADD CONSTRAINT "Concept_space_id_fkey" FOREIGN KEY ("space_id") REFERENCES "public"."DiscourseSpace"("id") ON UPDATE CASCADE ON DELETE CASCADE;
