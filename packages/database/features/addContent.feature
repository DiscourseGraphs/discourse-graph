  ...
  Scenario Outline: Calling the upsert steps separately
    ...
    And user user1 upserts this content to space s1:
      ...
      [
        ...
        { "author_local_id": "user2", "document_local_id":"page1_uid", "space_local_id": "s1", "source_local_id": "s2", "scale":"document", "created": "2000/01/02", "last_modified": "2001/01/03", "part_of_local_id":"s1", "text": "Some subtext" },
        {
          "space_local_id": "s1", "author_local_id": "user2", "document_inline": { "source_local_id": "page1_uid", "space_local_id": "s1", "created": "2000/01/01", "last_modified": "2001/01/02", "author_local_id":"user2"}, "source_local_id": "s3", "scale": "document", "created": "2000/01/02", "last_modified": "2001/01/03", "part_of_local_id": "s2", "text": "Some subsubtext", "embedding_inline": {
