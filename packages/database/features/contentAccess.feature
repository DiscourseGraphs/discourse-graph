  ...
  * The content rows of a space should not be available to non-members
  ...
  Background:
    ...
    And Document are added to the database:
      ...
      | d1  | s1        | abc             | user1      | 2025/01/01 | 2025/01/01    | text/roam+markdown |
      | d2  | s1        | def             | user2      | 2025/01/01 | 2025/01/01    | text/roam+markdown |
      | d3  | s2        | ghi             | user3      | 2025/01/01 | 2025/01/01    | text/roam+markdown |
