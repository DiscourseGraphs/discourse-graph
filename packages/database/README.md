...
4. Apply `npm run migrate --include-all` again, so the incoming migrations are applied, maybe out-of-order. You may have to fix the schema and reapply your migration to take the changes into account.
