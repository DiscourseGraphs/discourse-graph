...
type AgentRecord = {
  id: number;
  type: string;
  // Include other fields from your Agent table if they are selected
  [key: string]: any; // Keeping this flexible for now if other fields are dynamically selected
};

type CreateAgentEntryReturn = {
...
): Promise<CreateAgentEntryReturn> => {
