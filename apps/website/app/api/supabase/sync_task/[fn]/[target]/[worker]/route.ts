...
import { createApiResponse, asPostgrestFailure, handleRouteError } from "~/utils/supabase/apiUtils";
...
export const POST = async (
  ...
  try {
    ...
    if (!(Constants.public.Enums.task_status as readonly string[]).includes(infoS)) {
      return createApiResponse(
        request,
