...
![](/docs/guides/roam/command-palette-query-drawer.png)
...
![](/docs/guides/roam/query-drawer.png)

## Common Query Examples

### Evidence that Informs a Question

![](/docs/guides/roam/query-drawer-informs.png)

### Evidence that Supports a Claim

![](/docs/guides/roam/query-drawer-supports.png)
...
![](/docs/guides/roam/query-drawer-advanced.png)
...
![](/docs/guides/roam/query-drawer-advanced2.png)
