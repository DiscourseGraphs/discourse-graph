...
![Tagging candidate nodes demo](/docs/guides/roam/tagging-config.gif)
...
![Tagging candidate nodes keyboard shortcut](/docs/guides/roam/tagging-demo.gif)
...
![Formalizing candidate nodes](/docs/guides/roam/tagging-formalization.gif)
