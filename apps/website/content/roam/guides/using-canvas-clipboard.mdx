...
Click the **+ Add page** button and search for any page in your graph. Once added, the Clipboard lists every discourse node referenced on that page — this includes nodes linked or embedded anywhere on the page, not just nodes titled after the page itself.
...
![key image enabled](/docs/roam/clipboard05.png)
_This graph has "Key Image" enabled for Evidence nodes_

![Node with key image enabled](/docs/roam/clipboard05.png)
