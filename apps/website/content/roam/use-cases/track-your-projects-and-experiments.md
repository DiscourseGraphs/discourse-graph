...
![](/docs/roam/experiment-page-dashboard.png)
...
![](/docs/roam/project-page-new-experiment-button.png)

![](/docs/roam/home-page-projects-experiments-dashboard.png)
...
![](/docs/roam/jj-create-experiment-smartblock.png)
...
![](/docs/roam/create-experiment-modal.png)

The inputs for Model Organism and Experiment Type can be adjusted on your **🐭 🧪 Lab Housekeeping** page. Editing the lists under "Model organisms/systems" and "Type of Experiment" will change the dropdowns in the "Create Experiment" window.

![](/docs/roam/lab-housekeeping-model-systems-experiment-types.png)
