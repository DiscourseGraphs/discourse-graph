...
<Callout type="info" emoji="💡">
  This guide references a [roam example
  graph](https://roamresearch.com/#/app/template-lab/page/wnEmTP0TK) that you
  can download and use as a starterpack for creating your own discourse graph
</Callout>

- [Using Projects](#how-to-use-projects)
- [Using Experiments](#how-to-use-experiments)
- [Using Issues](#how-to-create-an-issue)
...
<Callout type="info" emoji="💡">
  To create a horizontal dashboard view of 2 or more blocks: place your cursor
  in their parent (un-indented) block, press `Ctrl-P` to bring up the command
  palette, select "change block view", then press "h" for horizontal.
</Callout>

<Image
  src="/docs/roam/project-dash.png"
  alt="Project page layout using the horizontal block view"
  width={1416}
  height={808}
...
<Image
  src="/docs/roam/project-page-overview.png"
...
<Image
  src="/docs/roam/new-project-modal.png"
  alt="the Create Project modal"
  width={726}
  height={437}
  className="docs-bordered-image"
/>
...
<Callout type="info" emoji="💡">
  You can create a new project from anywhere in your graph by typing `jj`
  followed by `createproject` (no spaces!)
</Callout>
...
<Image
  src="/docs/roam/experiment-page-dashboard.png"
  alt="example experiment page"
  width={1244}
  height={866}
  className="docs-bordered-image"
/>
...
<Image
  src="/docs/roam/project-page-new-experiment-button.png"
  alt="creating a new experiment from a project page"
  width={827}
  height={558}
  className="docs-bordered-image"
/>
...
<Image
  src="/docs/roam/home-page-projects-experiments-dashboard.png"
  alt="creating a new experiment from our home page"
  width={847}
  height={619}
  className="docs-bordered-image"
/>
_Creating a new Experiment from the home page_
...
<Image
  src="/docs/roam/jj-create-experiment-smartblock.png"
  alt="creating a new experiment from the smartblock hotkey menu"
  width={304}
  height={272}
  className="docs-bordered-image"
/>
...
<Image
  src="/docs/roam/create-experiment-modal.png"
  alt="the create experiment modal"
  width={823}
  height={637}
  className="docs-bordered-image"
/>
...
<Callout type="info" emoji="💡">
  If you're using the template graph, the inputs for Model Organism and
  Experiment Type can be adjusted on your **Lab Housekeeping** page. Editing the
  lists under "Model organisms/systems" and "Type of Experiment" will change the
  dropdowns in the "Create Experiment" window.
</Callout>

<Image
  src="/docs/roam/lab-housekeeping-model-systems-experiment-types.png"
  alt="experiment options menu"
  width={250}
  height={465}
  className="docs-bordered-image"
/>
_The Experiment options menu_
...
<Image
  src="/docs/roam/new-entry-button.png"
  alt="creating a log entry"
  width={1012}
  height={281}
  className="docs-bordered-image"
/>
...
<Callout type="info" emoji="💡">
  The same entry will show up on your **Home page**; you can edit in either
  place
</Callout>
...
<Image
  src="/docs/roam/add-image-menu.gif"
  alt="adding images by drag-and-drop and from the image upload menu"
  width={800}
  height={680}
  className="docs-bordered-image"
  unoptimized
...
<Image
  src="/docs/roam/candidate-node-menu.gif"
  alt="the candidate node menu"
  width={800}
  height={694}
  className="docs-bordered-image"
  unoptimized
/>
_Marking candidate nodes using the `\` menu_
...
<Image
  src="/docs/roam/add-node-tag-icon.png"
  alt="the Add Node Tag icon"
  width={252}
  height={270}
  className="docs-bordered-image"
/>
_The Add Node Tag icon_
<Image
  src="/docs/roam/candidate-tag-dropdown.png"
  alt="the candidate tag dropdown menu"
  width={400}
  height={440}
  className="docs-bordered-image"
/>
_Opening the node tag menu_
<Image
  src="/docs/roam/candidate-tag-applied.png"
  alt="a candidate tag applied to an image"
  width={400}
  height={440}
  className="docs-bordered-image"
/>
_Tagging an image as a Result_

You can use the candidate node menu the same way to mark **issue candidates**: possible future analyses or experiments.

<Image
  src="/docs/roam/save-issue-candidate.gif"
  alt="saving an issue candidate"
  width={400}
  height={150}
  className="docs-bordered-image"
  unoptimized
/>
_Marking an issue candidate -- a request for a future experiment_
...
<Image
  src="/docs/roam/experiment-todos-list.png"
  alt="the experiment todos list"
  width={868}
  height={628}
  className="docs-bordered-image"
/>
...
<Image
  src="/docs/roam/set-issue-status-type.gif"
  alt="setting the Issue status and type"
  width={800}
  height={635}
  className="docs-bordered-image"
  unoptimized
/>
_Highlighting text to create an Issue_

<Callout type="info" emoji="💡">
  Pressing capital `I` creates an Issue, while lowercase `i` converts the
  selected text into an issue candidate instead
</Callout>

Any text nested under the text you select will show up in the Issue Description, even after the Issue has been created.

<Image
  src="/docs/roam/issue-description-nested-text.png"
  alt="nested text copied into the Issue Description"
  width={1503}
  height={523}
  className="docs-bordered-image"
/>
_Viewing a newly-created issue in the sidebar_
...
<Image
  src="/docs/roam/candidate-node-creation-menu.png"
  alt="the candidate node creation menu"
  width={640}
  height={310}
  className="docs-bordered-image"
/>
_The candidate node menu_

Once the candidate node has been created, hover over the node tag (<NodeTag type="iss" />) to summon the node creation popup menu and create your new Issue.

<Image
  src="/docs/roam/convert-candidate-to-issue.gif"
  alt="converting a candidate node into an Issue"
  width={1495}
  height={543}
  className="docs-bordered-image"
  unoptimized
...
<Image
  src="/docs/roam/issue-query.png"
  alt="an issue query dashboard"
  width={640}
  height={310}
  className="docs-bordered-image"
/>
_A query surfacing Issues in your graph_

### Claiming an Issue

If you're working in a shared graph, claiming an issue alerts your colleagues that you intend to attack the problem identified in the issiue. It's like calling "got it!" when fielding a fly ball.

If you're working in a single-player graph, claiming an issue is more like formalizing a candidate node: you've decided that this problem is worth promoting to an Experiment and exploring further.

<Image
  src="/docs/roam/kickball.png"
  alt="issue claiming follows kickball fielding rules"
  width={737}
  height={416}
  className="docs-bordered-image"
  unoptimized
...
Navigate to the Issue page you'd like to work on, click `"Claim Issue"`, and complete the experiment setup form that pops up by adding a target question/hypothesis & project.

<Image
  src="/docs/roam/claim-issue.gif"
  alt="claiming an issue and completing the experiment setup form"
  width={800}
  height={690}
  className="docs-bordered-image"
  unoptimized
/>
_Claiming an Issue and setting up the resulting Experiment_
