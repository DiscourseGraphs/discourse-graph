...
Let's assume that your exploration phase is influenced by the items in your reference manager/personal library. The [template lab graph](https://github.com/DiscourseGraphs/obsidian-lab-example) uses [Zotero](https://github.com/8bitgentleman/zotero-roam), a Roam plugin for interacting with the Zotero refrence management software available on Roam Depot.
...
The [Discourse Canvas]() can be used to assemble your claims and evidence into an overview of the state of the field in relation to your target question.
