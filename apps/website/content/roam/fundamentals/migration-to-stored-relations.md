...
This guide covers the migration flow from **Personal Settings** for older installs. If you're new to stored relations, start with the [stored relations overview](/docs/roam/fundamentals/stored-relations).
