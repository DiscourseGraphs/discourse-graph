...
![explore/exploit curve](/docs/obsidian/exp-exp.png)
...
![ref manager](/docs/obsidian/biblio.png)
...
>
> ![a note from a former president | 250](/docs/obsidian/obama.png)
...
![settings | 350](/docs/obsidian/zotsidian-settings.png)
...
![hover card](/docs/obsidian/hover.png)
...
![Sources Base](/docs/obsidian/source-base01.png)

## Synthesis workflows

![starting out](/docs/obsidian/exp-exp01.png)
...
![a question](/docs/obsidian/merton-que.png)
...
>
> ![alt text](/docs/obsidian/merton-mentions.png)
...
![new question](/docs/obsidian/new-q.png)
...
![media log](/docs/obsidian/med-log-ex.png)

![linked mentions](/docs/obsidian/linked-men.png)
...
![lit review](/docs/obsidian/lit-rev.png)
...
![lit review](/docs/obsidian/lit-rev02.png)
...
![lit synthesis](/docs/obsidian/lit-synth-canvas.png)

In the discourse graph workflow, these phases are largely simultaneous and mutually informative.

![moving along the curve](/docs/obsidian/exp-exp02.png)
