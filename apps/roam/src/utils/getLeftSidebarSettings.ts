...
// Per-user fold state for the (shared) global section lives in a marker block
// under the Left Sidebar node, named per user so each person folds their own view.
