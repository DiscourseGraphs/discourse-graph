...
import { renderCanvasFrameEmbed } from "~/components/canvas/CanvasFrameEmbed";
...
export const initObservers = ({
  ...
  const canvasFrameEmbedObserver = createButtonObserver({
    attribute: "dg-frame",
    render: (b) => renderCanvasFrameEmbed(b, onloadArgs),
  });
