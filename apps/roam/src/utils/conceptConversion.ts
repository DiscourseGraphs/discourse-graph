...
// https://web.archive.org/web/20240813021041/https://www.putyourleftfoot.in/introduction-to-the-roam-alpha-api/
// https://roamresearch.com/#/app/developer-documentation/page/j6s5Gd5js
// https://github.com/RoamJS/roamjs-components (uses above)

// note:
// <div data-roamjs-lztroscld="true">
// <div class="rm-block-children...">
// <div data-create-time="1740765836577" data-edit-display-name="Michael Gartner" data-edit-time="1740765836577" class="roam-block-container ..." data-page-title="discourse-graph/nodes/Claim" data-edit-photo-url="https://lh3.googleusercontent.com/a/ACg8ocJhN2uTo0JYoa2CaCgj9Mb26BcvUbhI_GEvmAZcBD1W54buuJmeHw=s96-c" data-path-page-links="[]">
// <div id="block-input-sR22zZ470dNPkIf9PpjQXXdTBjG2-body-outline-LZTROsclD-R5yIQKO8o" class="rm-block__input rm-block__input--view roam-block dont-unfocus-block hoverparent rm-block-text" tabindex="0">

// window.roamAlphaAPI.q(`[:find ?Namespace ?Attribute
//  :where [_ ?Attribute]
// [(namespace ?Attribute) ?Namespace]]`)
// gives me the following:

const ROAM_ATTRIBUTES = [
    "attrs/lookup",
    "block/children",
    "block/heading",
    "block/open",
...
// From those two, a function could in theory ensure that a concept's dependendent concepts are already in the database.
