    ...
    <div className="chat-input">
      ...
      >
        <div className="prompt-tags">
          <div
            className={
              "chat-context-select " + (isContextToolActive ? "active" : "")
            }
          >
            ...
            <select
              ...
              value=" "
              onChange={(e) => {
                const action = ADD_CONTEXT_ACTIONS.find(
          ...
          {selectedShapes.length > 0 && (
            <SelectionTag onClick={() => editor.selectNone()} />
          )}
          ...
          <div className="chat-actions-left">
            <div className="chat-model-select">
              ...
              <select
                value={modelName}
                onChange={(e) =>
                  agent.$modelName.set(e.target.value as AgentModelName)
                }
              >
...
const ADD_CONTEXT_ACTIONS = [
  ...
  },
  {
    ...
    onSelect: (editor: Editor) => {
      ...
      if (
        currentTool.id === "target-area" ||
        currentTool.id === "target-shape"
      ) {
